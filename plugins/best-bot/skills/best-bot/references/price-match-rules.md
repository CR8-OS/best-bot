...
before calling it a find.

**2. A qualified competitor is cheaper.** Harder. Every rule below applies.
...
delivery is genuinely unknown, and say plainly that the end date is
conservative and the real deadline is probably later.
...
| My Best Buy Plus | 60 days |
| My Best Buy Total | 60 days |
| Activatable devices (cell phones, cellular tablets, mobile hotspots, cellular wearables) | 14 days, all customers |
| Verizon activatable devices | 30 days, all customers |
| Hearing aids, pet training devices | 60 days, all customers |
| Litter boxes | 90 days, all customers |
| Holiday decorations | 15 days, all customers including members |
...
- **New, in stock, immediately available.** Not open-box, refurbished,
  clearance, pre-owned, backordered, out of stock, or limited-quantity.

### Full exclusion list

A price is not matchable if it is or involves any of:

- Special daily or hourly sales
- Black Friday pricing, and everything from the Thursday before Thanksgiving
  through the Monday after
- Competitor special-event and holiday-sale pricing
- Clearance, open-box, refurbished, pre-owned, or out-of-stock items
- Limited-quantity offers
- Bundles, or any offer including a free item
- Coupon offers and mail-in offers
- Financing offers, credit card offers, gift card offers
- Trade-in offers
- Subscription services
- Membership-exclusive or loyalty pricing
- Pricing errors
...
Returning and rebuying at the lower price is sometimes floated as a fallback
when a match is refused. It is not free:

- **$45** on activatable devices
- **15%** on drones, digital cameras, camera lenses, camcorders, projectors,
  projector screens, golf launch monitors, scooters, mobility devices, and
  special-order products
- Waived in AL, CO, HI, IA, MS, OH, OK, SC, and on unopened items

Do not raise return-and-rebuy for any category carrying a restocking fee
unless the price drop clearly exceeds the fee. When raising it, state the fee.
...
## Price protection is not a thing here
