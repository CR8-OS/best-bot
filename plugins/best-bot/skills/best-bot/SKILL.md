...
5. On a qualifying find: notify with retailer, URL, price, seller, stock
   status, dollar difference, and which rules it passes. Include the claim
   script.
6. On nothing: stay silent. Do not notify.
7. If the check could not run — page blocked, SKU gone, no browser available —
